...
public:
   ...
   */
  virtual void
  AddStringProperty(const llvm::Twine &key, std::function<std::string()> getter,
   ...
   */
  virtual void
  AddBooleanArrayProperty(const llvm::Twine &key,
   ...
   */
  virtual void
  AddValueProperty(const llvm::Twine &key,
