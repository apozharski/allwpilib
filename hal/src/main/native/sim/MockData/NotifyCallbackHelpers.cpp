...
RegisterCallback(std::shared_ptr<NotifyListenerVector> currentVector,
...
std::shared_ptr<NotifyListenerVector>
CancelCallback(std::shared_ptr<NotifyListenerVector> currentVector,
               int32_t uid) {
...
std::shared_ptr<BufferListenerVector>
RegisterCallback(std::shared_ptr<BufferListenerVector> currentVector,
...
std::shared_ptr<BufferListenerVector>
CancelCallback(std::shared_ptr<BufferListenerVector> currentVector,
               int32_t uid) {
...
std::shared_ptr<ConstBufferListenerVector>
RegisterCallback(std::shared_ptr<ConstBufferListenerVector> currentVector,
...
std::shared_ptr<ConstBufferListenerVector>
CancelCallback(std::shared_ptr<ConstBufferListenerVector> currentVector,
               int32_t uid) {
